...
export default function EditSchedulePage() {
  ...
  const fetchData = async () => {
    try {
      const [scheduleData, detailsData, workoutsData] = await Promise.all([
    ...
    if (draggedWorkout) {
      if (draggedFromDay) {
        ...
        const newWorkout = {
          ...
          sets: draggedWorkout.sets || 3,
          reps: draggedWorkout.reps || 10,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await supabaseApi.updateSchedule(params.id, {
        name: formData.name,
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1">Drag and drop to modify the weekly schedule</p>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-gray-700 text-sm font-bold mb-3">Description</label>
                  <textarea
                    name="description"
